...
public class PIDControllerOld {
     ...
     */
    public PIDControllerOld(double Kp, double Ki, double Kd) {
        m_P = Kp;
        m_I = Ki;
        m_D = Kd;
    }
    ...
    private void calculate() {
        ...
        if (debugLog) {
            DebugLog.log("PIDController - m_setpoint = %.1f, m_input = %.1f, m_error = %.1f, m_totalError = %.1f, m_result = %.1f, P = %.1f, I = %.1f, D = %.1f", m_setpoint, m_input, m_error, m_totalError, m_result, m_P, m_I, m_D);
        }
